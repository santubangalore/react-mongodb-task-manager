...
const CommonDialog = ({showDialog,setShowDialog,title,formControls,formData,btnText,handleSubmit}) => {
  return (
    <Dialog open={showDialog} onOpenChange={()=>setShowDialog(false)} className=''>
